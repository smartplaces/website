...
(function (factory) {
	...
	$.fn.onepage_scroll = function(options){
		...
		$.fn.moveDown = function() {
			...
			if(settings.pagination == true) {
				...
				$(".onepage-pagination li" + "[data-index='" + index + "']").removeClass("active");
				$(".onepage-pagination li" + "[data-index='" + next.data("index") + "']").addClass("active");
			}
        ...
        $(".onepage-pagination li" + ".active").removeClass("active");
				$(".onepage-pagination li" + "[data-index='" + (page_index) + "']").addClass("active");
    ...
    */
		...
		if(window.location.hash != "" && window.location.hash != "#1") {
			...
			if(settings.pagination == true) $(".onepage-pagination li" + "[data-index='" + init_index + "']").addClass("active");
			...
			if(settings.pagination == true) $(".onepage-pagination li" + "[data-index='1']").addClass("active");
		}
		if(settings.pagination == true)  {
